...

{
    public class UsersController : Controller
    {
       ...
       //xyz tem que ser substituido pelo endereço da sua API.
        ...
        [HttpPost]
        public async Task<ActionResult> RegistrarAsync(UserModel u)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult> AutenticarAsync(UserModel u)
        {
            try
            {
                HttpClient httpClient = new HttpClient();
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    UserModel uLogado = JsonConvert.DeserializeObject<UserModel>(serialized);
        ...
        public async Task<ActionResult> IndexInformacoesAsync()
        {
            try
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    UserModel u = await Task.Run(() =>
                    JsonConvert.DeserializeObject<UserModel>(serialized));
                    return View(u);
                }
                else
                {
        ...
        [HttpPost]
        public async Task<ActionResult> AlterarEmail(UserModel u)
        {
            try
            {
                HttpClient httpClient = new HttpClient();
        ...
        [HttpPost]
        public async Task<ActionResult> AlterarSenha(UserModel u)
        {
            try
            {
                HttpClient httpClient = new HttpClient();
